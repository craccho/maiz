...
class RBS::CharScanner < StringScanner
  def charpos; end
  def initialize(string); end
  def original_charpos; end
  def scan(pattern); end
end
module RBS::MethodNameHelper
  def method_name_string; end
end
class RBS::ErrorBase < StandardError
end
class RBS::ParsingError < RBS::ErrorBase
end
class RBS::LoadingError < RBS::ErrorBase
end
class RBS::DefinitionError < RBS::ErrorBase
end
...
class RBS::NoTypeFoundError < RBS::ErrorBase
...
class RBS::Location
  ...
  def to_s; end
  def with_children(required: nil, optional: nil); end
end
class RBS::Location::WithChildren < RBS::Location
  def [](key); end
  def initialize(buffer:, start_pos:, end_pos:); end
  def initialize_copy(from); end
  def merge_optional(hash); end
  def merge_required(hash); end
  def optional_children; end
  def required_children; end
end
class RBS::Namespace
  def +(other); end
  def ==(other); end
...
module RBS::AST::Members::Attribute
  ...
  def name; end
  def type; end
  def update(name: nil, type: nil, ivar_name: nil, kind: nil, annotations: nil, location: nil, comment: nil); end
end
...
class RBS::Parser::SyntaxError < RBS::ParsingError
  def error_value; end
  def initialize(token_str:, error_value:, value_stack: nil); end
  def token_str; end
  def value_stack; end
end
class RBS::Parser::SemanticsError < RBS::ParsingError
  def initialize(message, subject:, location:); end
  def location; end
  def original_message; end
  def subject; end
end
class RBS::Parser::LexerError < RBS::ParsingError
  def initialize(input:, location:); end
  def input; end
  def location; end
end
