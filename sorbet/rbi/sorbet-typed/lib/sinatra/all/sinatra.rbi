...
class Sinatra::Context < Sinatra::Base
...
class Sinatra::Base
  ...
  sig {params(path: String, opts: T.untyped, block: T.proc.bind(Sinatra::Context).returns(T.untyped)).void}
...
module Sinatra::BasicAuth
  sig { params(realm: String, block: T.proc.void).void }
  def protect(realm, &block); end
  sig { params(realm: String, block: T.proc.params(username: String, password: String).void).void }
  def authorize(realm, &block); end
end